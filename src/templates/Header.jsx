...
>
    ...
    <p className='text-white '>
        <i className="ri-megaphone-line text-yellow-400"></i> {data.release_date || "No Information"}
        <i className=" ml-5 ri-dvd-line text-yellow-400"></i> {data.media_type.toUpperCase()}
