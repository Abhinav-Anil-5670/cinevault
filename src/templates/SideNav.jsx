    ...
    <>
      ...
      <div className={`fixed lg:static top-0 left-0 h-full border-r-2 border-zinc-200 p-10 bg-[#1F1E24] transition-transform duration-300 z-40 
        ...
        <nav className='flex flex-col text-zinc-400 text-xl gap-3'>
          ...
          <Link className='hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5'><i className="ri-fire-line"></i> Trending</Link>
          <Link className='hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5'><i className="ri-bard-line"></i> Popular</Link>
          <Link className='hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5'><i className="ri-movie-line"></i> Movies</Link>
          <Link className='hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-5'><i className="ri-tv-2-line"></i> Tv Shows</Link>
